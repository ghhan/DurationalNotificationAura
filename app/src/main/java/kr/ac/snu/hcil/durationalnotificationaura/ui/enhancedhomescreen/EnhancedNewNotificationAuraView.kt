...
class EnhancedNewNotificationAuraView(context: Context, attrs: AttributeSet?): View(context, attrs){
    ...
    private var visualEffect: AbstractAnotherVisEffect? = null
    ...
    fun setVisualEffect(visEffect: AbstractAnotherVisEffect){
